...
export class LoginService {
  ...
  private apiAuthUrl = 'https://s1137628-iprwc.store:8081/api/v1/auth/authenticate';
  private apiRegisterUrl = 'https://s1137628-iprwc.store:8081/api/v1/auth/register'
